...
Because the point is that you end up not needing this.
...
And expect nothing for the first few days. That is normal. Trying harder is the
one thing that reliably blocks it.

[pause 0.9]

That is everything. Start with the first phrase.
